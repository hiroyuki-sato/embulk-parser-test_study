module Embulk
  module Guess
    ...
    #      $ embulk guess -g "test_study" partial-config.yml
    #
    #      Depending on the file format the plugin uses, you can use choose
    #      one of binary guess (GuessPlugin), text guess (TextGuessPlugin),
    #      or line guess (LineGuessPlugin).

    #class TestStudy < GuessPlugin
    #  Plugin.register_guess("test_study", self)
    #
    #  def guess(config, sample_buffer)
    #    if sample_buffer[0,2] == GZIP_HEADER
    #      guessed = {}
    #      guessed["type"] = "test_study"
    ...
    #class TestStudy < TextGuessPlugin
    #  Plugin.register_guess("test_study", self)
    #
    ...
    #class TestStudy < LineGuessPlugin
    #  Plugin.register_guess("test_study", self)
    #
